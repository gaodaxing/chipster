...
# PARAMETER OPTIONAL organism: "Reference organism" TYPE [other, Arabidopsis_thaliana.TAIR10.27, Bos_taurus.UMD3.1.80, Canis_familiaris.BROADD2.67, Canis_familiaris.CanFam3.1.80, Drosophila_melanogaster.BDGP5.78,Drosophila_melanogaster.BDGP6.80, Felis_catus.Felis_catus_6.2.80, Gallus_gallus.Galgal4.80, Gasterosteus_aculeatus.BROADS1.80,Halorubrum_lacusprofundi_atcc_49239.GCA_000022205.1.27, Homo_sapiens.GRCh37.75, Homo_sapiens.GRCh38.80, Homo_sapiens.NCBI36.54,Medicago_truncatula.GCA_000219495.2.27, Mus_musculus.GRCm38.80, Mus_musculus.NCBIM37.67, Ovis_aries.Oar_v3.1.80, Populus_trichocarpa.JGI2.0.27,Rattus_norvegicus.RGSC3.4.69, Rattus_norvegicus.Rnor_5.0.79, Rattus_norvegicus.Rnor_6.0.80, Schizosaccharomyces_pombe.ASM294v2.27,Solanum_tuberosum.3.0.27, Sus_scrofa.Sscrofa10.2.80, Vitis_vinifera.IGGP_12x.27, Yersinia_enterocolitica_subsp_palearctica_y11.GCA_000253175.1.27] DEFAULT other (You can use own GTF file or one of those provided on the server.)
